...
public class GuessingGameController {
	...
	/**
	 * Called to indicate that the current guess is correct. Set the min and max to
	 * the current guess.
	 */
	...
	/**
	 * Called to indicate that the user is thinking of a number that is less than
	 * the current guess.
	 */
	...
	/**
	 * Called to indicate that the user is thinking of a number that is greater than
	 * the current guess.
	 */
