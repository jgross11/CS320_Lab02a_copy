package edu.ycp.cs320.PersonalizedCommencementProject.main;
...
public class Main {
	public static void main(String[] args) throws Exception {
		...
		Server server = launcher.launch(true, 8081, warFile.getAbsolutePath(), "/PersonalizedCommencementProject");
